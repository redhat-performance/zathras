...
General options
  ...
  --upload_directory <directory>:  Directory location for any extra file uploads to occur to
...
. results info: Created in the run directory, Contains the run information of all the tests.A
* Example file
----
========================================
