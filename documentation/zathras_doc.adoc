...
General options
  ...
  --create_attempts: number of times we attempt to create an instance to get the
    desginated cpu type
  --gate_pid: <pid>  If non zero value, the pid of the process we are to wait for completion of.
    ...
    be specified
      ...
      &lt;instance&gt;:&ltCloud_Placement&gt;&lt;CPU_type&gt;&amp;&lt;Disks&gt;&amp;&lt;Networks&gt;&amp;&lt;Sysctl_settings&gt;
       ...
       System config file Examples
         ...
         Example 3: Designate m5.24xlarge, 8 gp3 disks of 1200 Gig, iops of 3000, throughput 3000Gb
           m5.24xlarge:Disks;number=8;size=1200;type=gp3;iops=3000;throughput=3000
         Example 4: Designate m5.24xlarge with 4 networks
           m5.24xlarge:Networks;number=4
         Example 5: Designate m5.24xlarge with sys tunings udp_fix and none
           m5.24xlarge:Sysctl_settings=none+udp_fix
         Example 6: Designate m5.xlarge to be created in us-east-1 and zone b
  ...
  --sync_up: <0/1>.  Syncs up the start of the testing on multiple systems.  0=no, 1=yes
